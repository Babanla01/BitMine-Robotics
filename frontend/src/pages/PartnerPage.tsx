...
export default function PartnerPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const responseData = await applicationResponse.json();
      console.log('Partnership application submitted successfully:', responseData);

      // Step 2: Send confirmation email (optional - don't fail if this doesn't work)
      try {
        const serviceId = 'service_c4xxg3q';
        const templateId = 'template_partnership';
        ...
        const templateParams = {
          ...
          message: formData.message,
          to_email: 'partnerships@bitminerobotics.com'
        };
        ...
        // Continue anyway - backend submission was successful
      }
      ...
      setSubmitError(`Failed to submit partnership request: ${error instanceof Error ? error.message : 'Unknown error'}`);
      setSubmitSuccess(false);
    } finally {
